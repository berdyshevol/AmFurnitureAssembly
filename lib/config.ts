...
export const aboutPageContent = {
  ...
  services: {
    ...
    description: "At AM Furniture Assembly, we specialize in:",
    items: [
...
export const howItWorksSteps = [
  {
    ...
    title: "Book",
    description:
      "Contact us for a free estimate. Tell us what you need assembled and we'll provide a clear quote.",
  },
  {
    number: 2,
    title: "We Arrive",
    description:
      "We show up on time, fully equipped with all the tools needed to get the job done right.",
  },
  {
    number: 3,
    title: "Done",
    description:
      "Professional assembly, thorough cleanup, and a workspace left spotless. Enjoy your new furniture.",
  },
] as const;
...
export const pageMetadata = {
  layout: {
    title:
      "AM Furniture Assembly | Professional Furniture Assembly in Dallas-Fort Worth, TX",
    description:
...
export const pageHeroes = {
  about: { src: "/photos/hero1.png", alt: "Cabinet assembly in progress" },
  services: {
    src: "/photos/hero3.png",
    alt: "White open shelving unit assembled by AM Furniture Assembly",
  },
  pricing: {
    src: "/photos/hero2.png",
    alt: "Modern wall-mounted storage unit with wood and white finish",
  },
  gallery: {
